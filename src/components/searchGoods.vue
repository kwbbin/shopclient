  ...
  <div class="GoodsDetail">
   ...
   <div id="header_top"> 
    ...
    <div id="header " class="header page_style"> 
     ...
     <!--结束图层--> 
     <div class="Search"> 
      <p><input name="" type="text" v-model="mySearchStr" class="text" /><input name="" type="submit" value="搜 索" @click="searchGoods()"  class="Search_btn" /></p> 
    ...
    <div class="middle clearfix">
        <div>
            <el-breadcrumb separator="/" style="margin-bottom:20px">
                ...
                <el-breadcrumb-item>查找：<span style="color:#0000cc">{{searchStr}}</span> 的相关商品</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div>
...
export default {
  ...
  methods: {
    ...
    initData:function(){
        var This = this;
       var json = {str:This.searchStr}
        this.requestPost('/goods/searchGoods',json,function() {
    ...
    searchGoods:function(){
      var This = this;
      var json = {str:This.mySearchStr}
        this.requestPost('/goods/searchGoods',json,function() {
            This.goods = This.mydata;
            This.searchStr = This.mySearchStr;
        },null);
